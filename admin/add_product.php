...
<div class="form-group mt-2">
            ...
            <input type="number" class="form-control" id="product-offer" name="special-offer" placeholder="sale%" required/>
</div>
...
<div class="form-group mt-2">
    ...
    <div class="form-group mt-2">
            <label>Product Customizaton Status (Yes | No)</label>
            <input type="text" class="form-control" id="cus-status" name="cus-status" placeholder="customization-status" required/>
</div>
