    ...
    $stmt->store_result();
        ...
        if($stmt->num_rows( ) == 1){
         ...
         $stmt->fetch();
          ...
          header('location:index.php?login_success=logginged success');
...
//error
header('location:login.php?error=somting wentwrong');
...
<main class="col-md-6 mx-auto col-lg-6 px-md-4 text-center">
    ...
    <h1 class ="h2"></h1>
    <div class ="btn-toolbar mb-2 md-md-0">
