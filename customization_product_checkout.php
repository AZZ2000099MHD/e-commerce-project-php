...
if ( !empty($_SESSION['customize_cart'])  ) {
...
<?php  include('layouts/header.php');  ?>
    ...
    <section class="my-5 py-5">
        ...
        <div class="mx-auto container">
                       <form id="checkout-form" action ="customize_product_order.php" method ="POST">
                       ...
                       <div class="form-group checkout-small-element">
                        ...
                        <div class="form-group checkout-large-element" >
                             <label for="customization_type">Choose main Customization Function/type :</label>
                            <select id="customization_type" name="customization_type">
                                <option value="logo"> 1.   Logo</option>
                                <option value="label">2.   Label</option>
                                <option value="package">3.   Package</option>
                                <option value="style">4.   Style</option>
                            </select>
                        ...
                        <div class="form-group checkout-large-element">
                            ...
                            <input type="text" class="form-control" id="cus_description_1"  name="cus_description_1" placeholder="Enter Your cus_description_1"/>
                        </div>

                        <div class="form-group checkout-large-element">
                            <label> Description 02</label>
                            <input type="text" class="form-control" id="cus_description_2"  name="cus_description_2" placeholder="Enter Your cus_description_2"/>
                        </div>
